...
export default function Header() {
  return (
    <header className="bg-white sticky top-0 z-40 border-b border-[#e1e5dc]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20 relative">
          ...
          <Link href="/" className="flex-shrink-0 self-stretch flex items-center">
            <Image
              src="/images/absolute-wordmark.svg"
              alt="Absolute Pest Services"
              width={264}
              height={64}
              className="h-12 w-[198px] object-contain sm:h-14 sm:w-[231px]"
              priority
            />
          </Link>
          ...
          <nav className="hidden lg:flex items-center space-x-1" aria-label="Main navigation">
            ...
            <div className="relative group">
              ...
              <div className="absolute top-full left-0 mt-1 w-56 bg-white rounded-lg shadow-lg border border-gray-100 opacity-0 invisible group-hover:opacity-100 group-hover:visible group-focus-within:opacity-100 group-focus-within:visible transition-all duration-200 z-50">
                <div className="p-2">
                  {[
          ...
          <div className="flex items-center gap-3">
            <a
              ...
              className="hidden sm:inline-flex items-center gap-2 text-[#173f35] hover:bg-[#f0f3e9] text-sm font-semibold px-4 py-2 rounded-lg transition-colors"
            >
              <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <Link
              ...
              className="hidden lg:inline-flex bg-[#173f35] hover:bg-[#285748] text-white text-sm font-semibold px-4 py-2 rounded-lg transition-colors"
            >
              Request Service
            </Link>
