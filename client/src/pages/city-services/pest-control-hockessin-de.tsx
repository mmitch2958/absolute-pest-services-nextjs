...
export default function GeneralPestControlHockessinDe() {
  ...
  const faqs = [{"q":"How often should I schedule pest control service in Hockessin, DE?","a":"Most Hockessin homeowners benefit from quarterly exterior barrier treatments combined with an as-needed interior program. High-pest-pressure properties near wooded areas may need bi-monthly service."},{"q":"Are your pest control treatments safe for children and pets in Hockessin?","a":"Yes. We use EPA-registered, low-toxicity products and follow strict application protocols. We'll advise you on any brief vacate times when necessary."},{"q":"Do you offer same-day pest control service in Hockessin, DE?","a":"We do our best to accommodate same-day or next-day service requests throughout Hockessin and surrounding areas. Call 484-643-2225 to check availability."},{"q":"What pests are most common in Hockessin?","a":"Hockessin homeowners most frequently call us about carpenter ants, stink bugs, spiders, and cockroaches. Seasonal patterns shift — spring brings ants, summer brings stinging insects, fall brings stink bugs and mice seeking warmth."}];
  ...
  "@graph": [
        ...
        "itemListElement": [
          {
            ...
            "itemOffered": {
              "@type": "Service",
              "name": "General Pest Control in Hockessin, DE",
              "description": "Professional general pest control services in Hockessin, DE. Our licensed technicians eliminate ants, spiders, cockroaches, stink bugs, silverfish, centipedes, and dozens of other common household pes"
            }
          }
        ]
      }
    },
    {
      ...
      "mainEntity": [
        {
          "@type": "Question",
          "name": "How often should I schedule pest control service in Hockessin, DE?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Most Hockessin homeowners benefit from quarterly exterior barrier treatments combined with an as-needed interior program. High-pest-pressure properties near wooded areas may need bi-monthly service."
          }
        },
        {
          "@type": "Question",
          "name": "Are your pest control treatments safe for children and pets in Hockessin?",
          "acceptedAnswer": {
            "@type": "Answer",
        ...
        {
          "@type": "Question",
          "name": "Do you offer same-day pest control service in Hockessin, DE?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "We do our best to accommodate same-day or next-day service requests throughout Hockessin and surrounding areas. Call 484-643-2225 to check availability."
          }
        },
        {
          "@type": "Question",
          "name": "What pests are most common in Hockessin?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Hockessin homeowners most frequently call us about carpenter ants, stink bugs, spiders, and cockroaches. Seasonal patterns shift — spring brings ants, summer brings stinging insects, fall brings stink bugs and mice seeking warmth."
          }
        }
      ]
    }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 to-blue-50">
      <Helmet>
        <title>General Pest Control in Hockessin, DE | Absolute Pest Services</title>
        <meta name="description" content="Expert general pest control in Hockessin, DE. Licensed & insured. Serving New Castle County. Free inspection available. Call 484-643-2225 for fast service." />
        <link rel="canonical" href="https://absolutepestservices.com/pest-control-hockessin-de/" />
        <meta property="og:title" content="General Pest Control in Hockessin, DE | Absolute Pest Services" />
        <meta property="og:description" content="Expert general pest control in Hockessin, DE. Licensed & insured. Serving New Castle County. Free inspection available. Call 484-643-2225 for fast service." />
        <meta property="og:url" content="https://absolutepestservices.com/pest-control-hockessin-de/" />
      ...
      <section className="bg-gradient-to-r from-[hsl(132,48%,35%)] to-[hsl(132,48%,25%)] py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="text-4xl sm:text-5xl font-bold text-white mb-6">
            General Pest Control in Hockessin, DE
          </h1>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-4xl font-bold text-gray-900 mb-4">General Pest Control in Hockessin, DE</h2>
              <p className="text-lg text-gray-700 mb-6 leading-relaxed">
                Professional general pest control services in Hockessin, DE. Our licensed technicians eliminate ants, spiders, cockroaches, stink bugs, silverfish, centipedes, and dozens of other common household pests. With the Brandywine Creek State Park border and heavily wooded Kennett Pike corridor, pest pressure in Hockessin can be intense — our barrier treatments and targeted interior applications keep infestations from taking hold.
              </p>
      ...
      <section className="py-20 bg-[hsl(0,0%,98%)]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-gray-900 mb-10 text-center">
            Frequently Asked Questions — General Pest Control in Hockessin
          </h2>
      ...
      <section className="py-16 bg-gradient-to-r from-[hsl(132,48%,35%)] to-[hsl(132,48%,25%)]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold text-white mb-4">Stop Pests in Hockessin Before They Take Over</h2>
          <p className="text-xl text-green-100 mb-8">Don't let common pests damage your Hockessin home or disrupt your family. Our licensed technicians serve all of Hockessin, DE and surrounding areas with fast, effective treatments.</p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="tel:+14846432225"
              className="inline-flex items-center justify-center bg-white text-[hsl(132,48%,35%)] px-8 py-4 text-lg font-semibold hover:bg-gray-100 rounded-md transition-colors"
