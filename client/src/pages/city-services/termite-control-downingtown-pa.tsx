...
export default function TermiteControlDowningtownPa() {
  const neighborhoods = ["Downingtown Borough","East Brandywine Township","Caln Township","Uwchlan Township","Glenmoore"];

  const bulletPoints = ["Free termite inspections for Downingtown homeowners","Sentricon® Colony Elimination System","Liquid barrier treatment (Termidor®)","Wood treatment & localized borate applications","Pre-construction soil treatment","Annual inspection & warranty programs","Termite damage assessment","Real estate inspection letters (WDO)"];

  const faqs = [{"q":"How do I know if my Downingtown home has termites?","a":"Common signs include mud tubes along foundation walls, hollow-sounding wood, discarded wings near windows, and frass (termite droppings). Our free inspection will confirm whether termites are present."},{"q":"What termite treatment method works best for Downingtown properties?","a":"We typically recommend the Sentricon® bait system for long-term colony elimination, or Termidor® liquid barrier for active infestations requiring faster knockdown. We'll recommend the right solution after inspection."},{"q":"How long does termite treatment take in Downingtown?","a":"Liquid barrier treatments are completed in a few hours. Sentricon® bait station installation takes 2–4 hours. Colony elimination typically occurs within 3 months of Sentricon® activation."},{"q":"Do you provide termite letters for real estate sales in Downingtown, PA?","a":"Yes. We perform Wood Destroying Organism (WDO) inspections and issue official inspection reports needed for Downingtown real estate transactions. Call to schedule promptly as closings often have tight timelines."}];
  ...
  "@graph": [
        ...
        "itemListElement": [
          {
            ...
            "itemOffered": {
              "@type": "Service",
              "name": "Termite Control in Downingtown, PA",
              "description": "Subterranean termites cause billions in property damage annually — and Downingtown, PA properties are not immune. With proximity to Marsh Creek State Park and the Brandywine Creek wildlife corridor, t"
            }
          }
        ]
      }
    },
    {
      ...
      "mainEntity": [
        {
          "@type": "Question",
          "name": "How do I know if my Downingtown home has termites?",
          "acceptedAnswer": {
            "@type": "Answer",
        ...
        {
          "@type": "Question",
          "name": "What termite treatment method works best for Downingtown properties?",
          "acceptedAnswer": {
            "@type": "Answer",
        ...
        {
          "@type": "Question",
          "name": "How long does termite treatment take in Downingtown?",
          "acceptedAnswer": {
            "@type": "Answer",
        ...
        {
          "@type": "Question",
          "name": "Do you provide termite letters for real estate sales in Downingtown, PA?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Yes. We perform Wood Destroying Organism (WDO) inspections and issue official inspection reports needed for Downingtown real estate transactions. Call to schedule promptly as closings often have tight timelines."
          }
        }
      ]
    }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 to-blue-50">
      <Helmet>
        <title>Termite Control in Downingtown, PA | Absolute Pest Services</title>
        <meta name="description" content="Expert termite control in Downingtown, PA. Licensed & insured. Serving Chester County. Free inspection available. Call 484-643-2225 for fast service." />
        <link rel="canonical" href="https://absolutepestservices.com/termite-control-downingtown-pa/" />
        <meta property="og:title" content="Termite Control in Downingtown, PA | Absolute Pest Services" />
        <meta property="og:description" content="Expert termite control in Downingtown, PA. Licensed & insured. Serving Chester County. Free inspection available. Call 484-643-2225 for fast service." />
        <meta property="og:url" content="https://absolutepestservices.com/termite-control-downingtown-pa/" />
      ...
      <section className="bg-gradient-to-r from-[hsl(132,48%,35%)] to-[hsl(132,48%,25%)] py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="text-4xl sm:text-5xl font-bold text-white mb-6">
            Termite Control & Treatment in Downingtown, PA
          </h1>
          ...
          <p className="text-green-200 mb-8 max-w-2xl mx-auto">
            Nestled along the Brandywine Creek corridor and adjacent to Marsh Creek State Park, Downingtown homes and businesses face year-round pest pressure from surrounding wooded green belts.
          </p>
          {/* Trust signals */}
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-4xl font-bold text-gray-900 mb-4">Termite Control in Downingtown, PA</h2>
              <p className="text-lg text-gray-700 mb-6 leading-relaxed">
                Subterranean termites cause billions in property damage annually — and Downingtown, PA properties are not immune. With proximity to Marsh Creek State Park and the Brandywine Creek wildlife corridor, the soil conditions and moisture levels in Downingtown create ideal termite habitat. Our termite inspections and Sentricon® Colony Elimination treatments stop termite colonies at the source before they compromise your home's structural integrity.
              </p>
              <Link href="/termites">
      ...
      <section className="py-20 bg-[hsl(0,0%,98%)]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-gray-900 mb-10 text-center">
            Frequently Asked Questions — Termite Control in Downingtown
          </h2>
      ...
      <section className="py-16 bg-gradient-to-r from-[hsl(132,48%,35%)] to-[hsl(132,48%,25%)]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold text-white mb-4">Protect Your Downingtown Home from Termites</h2>
          <p className="text-xl text-green-100 mb-8">Termite damage is rarely covered by homeowners insurance. Don't wait for signs — proactive termite protection for your Downingtown, PA property starts with a free inspection.</p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="tel:+14846432225"
              className="inline-flex items-center justify-center bg-white text-[hsl(132,48%,35%)] px-8 py-4 text-lg font-semibold hover:bg-gray-100 rounded-md transition-colors"
