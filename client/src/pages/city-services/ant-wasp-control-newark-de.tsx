...
export default function AntWaspControlNewarkDe() {
  const neighborhoods = ["Newark City", "University of Delaware Campus", "Brookside", "Glasgow", "White Clay Creek"];
  ...
  const faqs = [{"q":"What ants, wasps, and stinging insects are common in Newark?","a":"In Newark, we frequently treat carpenter ants, pavement ants, and odorous house ants. Stinging insects like yellow jackets, paper wasps, and bald-faced hornets are common in summer. Boxelder bugs and carpenter bees are also prevalent seasonal pests. Call us for a free inspection."},{"q":"When should I call for wasp and hornet nest removal in Newark?","a":"Call as soon as you spot a nest. Wasp and hornet colonies grow rapidly through summer. Early removal is safer and less expensive. We provide same-day or next-day service throughout Newark and surrounding areas."},{"q":"Do carpenter bees damage homes in Newark?","a":"Yes. Carpenter bees drill into wood siding, decks, fascia boards, and railings. Over time this causes structural damage and attracts woodpeckers. We treat existing galleries and apply preventive wood treatments to stop re-infestation."},{"q":"How much does ant and wasp control cost in Newark, DE?","a":"Cost depends on property size, infestation type, and treatment approach. We provide free inspections and transparent quotes before any work begins. Call 484-643-2225 to schedule your inspection."}];
  ...
  "@graph": [
        ...
        "itemListElement": [
          {
            ...
            "itemOffered": {
              "@type": "Service",
              "name": "Ant & Wasp Control in Newark, DE",
              "description": "Comprehensive ant, wasp, hornet, carpenter bee, and boxelder bug control for Newark, DE homes and businesses."
            }
          }
        ]
      }
    },
    {
      ...
      "mainEntity": [
        {
          "@type": "Question",
          "name": "What ants, wasps, and stinging insects are common in Newark?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "In Newark, we frequently treat carpenter ants, pavement ants, and odorous house ants. Stinging insects like yellow jackets, paper wasps, and bald-faced hornets are common in summer. Boxelder bugs and carpenter bees are also prevalent seasonal pests. Call us for a free inspection."
          }
        },
        {
          "@type": "Question",
          "name": "When should I call for wasp and hornet nest removal in Newark?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Call as soon as you spot a nest. Wasp and hornet colonies grow rapidly through summer. Early removal is safer and less expensive. We provide same-day or next-day service throughout Newark and surrounding areas."
          }
        },
        {
          "@type": "Question",
          "name": "Do carpenter bees damage homes in Newark?",
          "acceptedAnswer": {
            "@type": "Answer",
        ...
        {
          "@type": "Question",
          "name": "How much does ant and wasp control cost in Newark, DE?",
          "acceptedAnswer": {
            "@type": "Answer",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 to-blue-50">
      <Helmet>
        <title>Ant & Wasp Control in Newark, DE | Absolute Pest Services</title>
        <meta name="description" content="Expert ant, wasp, hornet & carpenter bee control in Newark, DE. Licensed & insured. Serving New Castle County. Free inspection available. Call 484-643-2225." />
        <link rel="canonical" href="https://absolutepestservices.com/ant-wasp-control-newark-de/" />
        <meta property="og:title" content="Ant & Wasp Control in Newark, DE | Absolute Pest Services" />
        <meta property="og:description" content="Expert ant, wasp, hornet & carpenter bee control in Newark, DE. Licensed & insured. Serving New Castle County. Free inspection available. Call 484-643-2225." />
        <meta property="og:url" content="https://absolutepestservices.com/ant-wasp-control-newark-de/" />
      ...
      <section className="bg-gradient-to-r from-[hsl(132,48%,35%)] to-[hsl(132,48%,25%)] py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-green-200 mb-8 max-w-2xl mx-auto">
            Newark's large student population, dense housing, and proximity to White Clay Creek Preserve create conditions favorable for carpenter bees, boxelder bugs, wasps, hornets, and ant infestations.
          </p>
          {/* Trust signals */}
      ...
      <section className="py-20 bg-[hsl(0,0%,98%)]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-gray-900 mb-10 text-center">
            Frequently Asked Questions — Ant & Wasp Control in Newark
          </h2>
      ...
      <section className="py-16 bg-gradient-to-r from-[hsl(132,48%,35%)] to-[hsl(132,48%,25%)]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold text-white mb-4">Wasps, Ants, or Carpenter Bees in Newark? Act Fast.</h2>
          <p className="text-xl text-green-100 mb-8">Stinging insect colonies and carpenter ant infestations grow quickly. Our Newark, DE team offers fast scheduling and guaranteed results.</p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="tel:+14846432225"
              className="inline-flex items-center justify-center bg-white text-[hsl(132,48%,35%)] px-8 py-4 text-lg font-semibold hover:bg-gray-100 rounded-md transition-colors"
