          ...
          <div className="flex justify-between items-center py-4">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="hidden lg:flex flex-col text-right">
                ...
                <span className="text-lg font-semibold text-teal-600">610-325-4000</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="bg-gradient-to-r from-teal-600 to-teal-700 py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="tel:+16103254000" className="bg-white text-teal-600 px-8 py-4 text-lg font-semibold hover:bg-gray-100">
