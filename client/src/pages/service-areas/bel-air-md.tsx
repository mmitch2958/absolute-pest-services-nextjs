...
export default function BelAirMD() {
  const cities = ["Bel Air Town", "Bel Air North", "Bel Air South", "Fallston", "Forest Hill", "Abingdon"];
      ...
      <section className="bg-gradient-to-r from-[hsl(132,48%,35%)] to-[hsl(132,48%,25%)] py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-5xl font-bold text-white mb-6">
            Bel Air, MD Pest Control Services
          </h1>
          <p className="text-xl text-green-100 mb-8 max-w-3xl mx-auto">
            Expert pest control for Bel Air and Harford County. From the I-95 corridor to growing suburban neighborhoods, we keep homes and businesses pest-free with proven, effective treatments.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Fast, reliable pest control throughout the Bel Air, MD area.
            </p>
          </div>
      ...
      <section className="py-20 bg-[hsl(0,0%,98%)]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Complete pest management solutions for Bel Air, MD homes and businesses.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">
              Nearby Service Areas — Pest Control Near Bel Air
            </h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              We serve Bel Air and surrounding communities throughout the region.
            </p>
          </div>
...
<Link href="/service-areas/pottstown-pa">
      ...
      <section className="py-20 bg-[hsl(0,0%,98%)]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">
              Our Pest Control Services in Bel Air
            </h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              From wildlife removal to termite protection, we offer comprehensive pest management tailored to Bel Air properties.
            </p>
          </div>
              ...
              <Card className="bg-white hover:shadow-lg transition-shadow cursor-pointer h-full">
                <CardContent className="p-5 flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500 mt-0.5">Inspection &amp; prevention in Bel Air</p>
                  </div>
                </CardContent>
              </Card>
            </Link>
              ...
              <Card className="bg-white hover:shadow-lg transition-shadow cursor-pointer h-full">
                <CardContent className="p-5 flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500 mt-0.5">Heat &amp; chemical options in Bel Air</p>
                  </div>
                </CardContent>
              </Card>
            </Link>
              ...
              <Card className="bg-white hover:shadow-lg transition-shadow cursor-pointer h-full">
                <CardContent className="p-5 flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500 mt-0.5">Mice &amp; rat extermination in Bel Air</p>
                  </div>
                </CardContent>
              </Card>
            </Link>
