...
export default function HockessinDE() {
  const cities = ["Hockessin", "Yorklyn", "Limestone Hills", "Ashland", "Brandywine Hundred North", "Centerville"];
      ...
      <section className="bg-gradient-to-r from-[hsl(132,48%,35%)] to-[hsl(132,48%,25%)] py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-5xl font-bold text-white mb-6">
            Hockessin, DE Pest Control Services
          </h1>
          <p className="text-xl text-green-100 mb-8 max-w-3xl mx-auto">
            Expert pest control for Hockessin's affluent, wooded communities. From the Kennett Pike corridor to the Pennsylvania border, we protect your home from wildlife and invasive pests.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Fast, reliable pest control throughout the Hockessin, DE area.
            </p>
          </div>
      ...
      <section className="py-20 bg-[hsl(0,0%,98%)]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Complete pest management solutions for Hockessin, DE homes and businesses.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">
              Nearby Service Areas — Pest Control Near Hockessin
            </h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              We serve Hockessin and surrounding communities throughout the region.
            </p>
          </div>
...
<Link href="/service-areas/wilmington-de">
      ...
      <section className="py-20 bg-[hsl(0,0%,98%)]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">
              Our Pest Control Services in Hockessin
            </h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              From wildlife removal to termite protection, we offer comprehensive pest management tailored to Hockessin properties.
            </p>
          </div>
