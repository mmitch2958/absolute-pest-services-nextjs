...
import { Phone, CheckCircle, AlertTriangle, Calendar, DollarSign, Shield, ArrowRight } from 'lucide-react'
...
const seasonTimeline = [
  {
    period: 'Mid-April – Early May',
    event: 'Adults emerge from overwintering tunnels when temperatures reach 65–70°F',
    isNow: true,
  },
  {
    period: 'Late April – May',
    event: 'Mating occurs; females search for nest sites and begin boring',
    isNow: false,
  },
  {
    period: 'May – July',
    event: 'Peak boring and egg-laying — females create 6–8 brood cells per gallery',
    isNow: false,
  },
  {
    period: 'July – August',
    event: 'Larvae develop and pupate inside sealed gallery cells',
    isNow: false,
  },
  {
    period: 'Late July – September',
    event: 'New adult bees emerge and feed on nectar before returning to overwinter',
    isNow: false,
  },
  {
    period: 'October – March',
    event: 'Adults overwinter inside existing galleries; no activity during cold months',
    isNow: false,
  },
]
...
const diyVsPro = [
  {
    title: 'Misidentification risk',
    diy: 'Not every large bee is a carpenter bee — you don\'t want to treat beneficial bumblebees or honeybees',
    pro: 'We correctly identify the species before treatment begins',
  },
  {
    title: 'Timing mistakes',
    diy: 'Sealing holes too early traps bees inside without contacting the treatment — they just bore new exits',
    pro: 'We time applications so bees contact the treatment before any sealing occurs',
  },
  {
    title: 'Incomplete treatment',
    diy: 'You can\'t see the full gallery system; branched tunnels and secondary holes are easy to miss',
    pro: 'We treat the complete tunnel system, not just visible entry holes',
  },
  {
    title: 'Safety concerns',
    diy: 'Insecticidal dust becomes airborne; ladders needed for eave treatment',
    pro: 'Licensed technicians handle all products safely at any height',
  },
  {
    title: 'Product selection',
    diy: 'Not all insecticides are formulated for tunnel application into wood',
    pro: 'We use professional-grade products formulated for carpenter bee galleries',
  },
  {
    title: 'Sealing protocol',
    diy: 'Plugging holes immediately defeats the treatment — bees need to pass through treated entry points first',
    pro: 'We seal 1–2 weeks after treatment, using proper materials for long-term prevention',
  },
]

export default function CarpenterBeesInfoPage() {
  useEffect(() => {
    const businessSchema = {
      '@context': 'https://schema.org',
      '@type': 'Service',
      name: 'Carpenter Bee Information',
      provider: {
        '@type': 'LocalBusiness',
    ...
    script.setAttribute('data-schema', 'service-carpenter-bee')
  ...
  return (
    <div className="min-h-screen bg-white">
      <Helmet>
        <title>Carpenter Bees in PA & DE — Complete Homeowner Guide | Absolute Pest Services</title>
        <meta
          name="description"
          content="Learn to identify carpenter bees, spot the damage early, and protect your PA or DE home before the holes multiply. Expert guide from Absolute Pest Services."
        />
        <link rel="canonical" href="https://absolutepestservices.com/carpenter-bees" />
        <meta
          property="og:title"
          content="Carpenter Bees in PA & DE — Complete Homeowner Guide"
        />
        <meta
          property="og:description"
          content="Learn to identify carpenter bees, spot the damage early, and protect your PA or DE home before the holes multiply."
        />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://absolutepestservices.com/carpenter-bees" />
      </Helmet>
      ...
      <section className="relative bg-gradient-to-br from-gray-800 to-gray-900 text-white py-20 overflow-hidden">
        {/* Subtle wood-grain background hint */}
        <div
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <QuoteRequestModal>
                <button className="inline-flex items-center gap-2 border-2 border-white/30 hover:border-white text-white font-bold px-8 py-4 rounded-xl text-lg transition-colors">
                  <Calendar size={20} />
                  Get Free Estimate
                </button>
              </QuoteRequestModal>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              The species in PA &amp; DE is the{' '}
              <strong>Eastern carpenter bee</strong> — here&apos;s how to tell them apart.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {beeComparison.map((bee) => (
              <Card key={bee.name} className="overflow-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              ...
              <p className="text-lg text-gray-600 leading-relaxed mb-6">
                ...
                They prefer softwoods like pine, cedar, and redwood, and they like wood at least
                2 inches thick.
              </p>
              <p className="text-lg text-gray-600 leading-relaxed mb-4">
                <strong>Important:</strong> Carpenter bees do NOT eat wood. They excavate tunnels
                purely for shelter and nesting. The tunnels — called galleries — start as a
                perfectly round ½-inch entry hole, go in about 1–2 inches, then turn 90° to
                follow the wood grain. A single gallery can run 6–12 inches long. Over multiple
                years, successive generations can expand galleries up to 10 feet.
              </p>
            </div>
            <div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 text-center">
            <p className="text-amber-700 bg-amber-50 border border-amber-200 rounded-lg px-6 py-4 inline-block font-medium">
              ...
              The stains darken over time and can become a secondary mold problem.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <p className="text-gray-600 leading-relaxed mb-6">
                ...
                and branches the existing gallery system.
              </p>
              <p className="text-gray-600 leading-relaxed mb-8">
                One untreated female this spring means 6–8 new bees this summer, each boring
                additional tunnels. Over 3–5 years, this compounds into significant hollowing of
                structural beams, fascia boards, deck posts, and roof overhangs.
              </p>
            ...
            <div>
                ...
                <Card className="border-green-200 bg-green-50">
                  <CardContent className="p-6">
                    ...
                    <p className="text-gray-700 font-medium">
                      ...
                      <span className="text-green-700 font-bold text-xl">hundreds</span> of dollars
                    </p>
                  </CardContent>
                </Card>
              ...
              <p className="mt-4 text-sm text-gray-500 italic">
                *Pricing varies by scope. These ranges are illustrative to show the cost escalation
                of untreated damage.
              </p>
            </div>
          </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 bg-green-700 text-white rounded-2xl p-8 max-w-3xl mx-auto text-center">
            ...
            <ul className="text-green-100 text-base space-y-2 text-left max-w-xl mx-auto mb-6">
              <li>• Killing one female in spring prevents 6–8 new bees from that gallery this summer</li>
              <li>• Treating early means fewer galleries to address and a smaller overall infestation</li>
              <li>• Every week of delay means more eggs laid in more holes</li>
            </ul>
            <p className="font-bold text-xl">The earlier you act, the less damage you prevent.</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              We get it — you&apos;re a homeowner who can handle things. But carpenter bee treatment
              has some pitfalls that catch even experienced DIYers off guard.
            </p>
          </div>

          <Accordion type="single" collapsible className="max-w-3xl mx-auto">
            {diyVsPro.map((item, index) => (
              <AccordionItem key={index} value={`item-${index}`}>
                <AccordionTrigger className="text-left font-semibold text-gray-900 text-base py-4">
                  {item.title}
                </AccordionTrigger>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="bg-red-50 border border-red-100 rounded-xl p-4">
                      <h5 className="font-bold text-red-700 mb-2 flex items-center gap-2">
                        <AlertTriangle className="w-4 h-4" /> DIY Risk
                      </h5>
                      <p className="text-gray-700 text-sm">{item.diy}</p>
                    </div>
                    <div className="bg-green-50 border border-green-100 rounded-xl p-4">
                      <h5 className="font-bold text-green-700 mb-2 flex items-center gap-2">
                        <CheckCircle className="w-4 h-4" /> Professional Advantage
                      </h5>
                      <p className="text-gray-700 text-sm">{item.pro}</p>
                    </div>
                  </div>
                </AccordionContent>
              </AccordionItem>
      ...
      <section className="py-16 bg-gradient-to-br from-green-700 to-green-800 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <a
              href={`tel:${PHONE}`}
              className="inline-flex items-center gap-3 bg-white text-green-800 font-bold px-10 py-5 rounded-xl text-xl shadow-lg hover:bg-green-50 transition-colors"
            >
              <Phone size={24} />
              {PHONE}
            </a>
            <a
              href="/contact"
              className="inline-flex items-center gap-2 border-2 border-white/40 text-white font-bold px-10 py-5 rounded-xl text-xl hover:border-white transition-colors"
            >
              Contact Us Online
              <ArrowRight size={20} />
            </a>
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-6 text-sm text-green-200">
            {['Licensed & Insured', 'Local Experts', 'Same-Day Service', 'Free Estimates'].map((badge) => (
