    ...
    <main>
      <section className="bg-gradient-to-br from-[#0a221c] to-[#203d34] text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-[#dbe6d6]">Last updated: {updated}</p>
        </div>
      </section>

      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg max-w-none text-[#3f5049]">

            <h2 className="text-xl font-bold text-[#203d34] mt-8 mb-3">1. Information We Collect</h2>
            <p>
            ...
            <h2 className="text-xl font-bold text-[#203d34] mt-8 mb-3">2. How We Use Your Information</h2>
            ...
            <h2 className="text-xl font-bold text-[#203d34] mt-8 mb-3">3. Information Sharing</h2>
            <p>
            ...
            <h2 className="text-xl font-bold text-[#203d34] mt-8 mb-3">4. Cookies</h2>
            <p>
            ...
            <h2 className="text-xl font-bold text-[#203d34] mt-8 mb-3">5. Data Security</h2>
            <p>
            ...
            <h2 className="text-xl font-bold text-[#203d34] mt-8 mb-3">6. Your Rights</h2>
            <p>
              You may request access to, correction of, or deletion of your personal information at any time by contacting us at <a href="mailto:info@absolutepestservices.com" className="text-[#173f35] hover:underline">info@absolutepestservices.com</a>.
            </p>

            <h2 className="text-xl font-bold text-[#203d34] mt-8 mb-3">7. Contact</h2>
            <p>
              If you have questions about this Privacy Policy, please contact us:
            </p>
            <p className="mt-2">
              <strong>Absolute Pest Services</strong><br />
              Phone: <a href="tel:4846432225" className="text-[#173f35] hover:underline">484-643-2225</a><br />
              Email: <a href="mailto:info@absolutepestservices.com" className="text-[#173f35] hover:underline">info@absolutepestservices.com</a>
            </p>
          </div>
        </div>
      </section>
