    ...
    const faqSchema = {
      ...
      "mainEntity": [
        ...
        },
        {
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Call us at 484-643-2225, use our online contact form, or click 'Schedule Inspection' on our website. We offer inspections throughout Chester County, Delaware County, Montgomery County PA, and New Castle County DE."
          }
        }
      ]
    };
  ...
  const serviceAreas = [
    {
      ...
      color: "bg-[hsl(132,48%,35%)]",
      locations: ["West Chester", "Kennett Square", "Chadds Ford", "Oxford", "And surrounding areas"]
    },
    {
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center text-white max-w-4xl mx-auto px-4">
            <h1 className="text-5xl lg:text-6xl font-bold mb-6 leading-tight text-[#f09000]">
              <span className="text-[hsl(36,100%,47%)]">Greater Philadelphia Area</span> Trusted Pest Experts.
            </h1>
          ...
          <div className="max-w-3xl mx-auto">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6">
                Absolute Pest Services offers the best in professional pest control service to southeastern Pennsylvania and northern Delaware. Our staff's many years of experience ensures that your pest problems will be taken care of quickly and efficiently.
              </p>
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Delaware County 610-325-4000</p>
                      <p className="text-gray-600">New Castle County 302-235-1975</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Call/Text 484-643-2225</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <a 
                        href="mailto:info@absolutepestservices.com" 
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col sm:flex-row justify-between items-center gap-4 text-gray-400 text-sm">
            <p>&copy; 2026 Absolute Pest Services. All rights reserved.</p>
