...
export default function ServiceAreas() {
  const serviceAreas = [
    {
      ...
      counties: ['Chester County', 'Delaware County', 'Montgomery County', 'Philadelphia County'],
      cities: ['West Grove', 'Oxford', 'Kennett Square', 'Avondale', 'Toughkenamon', 'Media', 'Philadelphia', 'Aston', 'Garnet Valley', 'Downingtown', 'King of Prussia', 'Malvern', 'Pottstown', 'Newtown Square']
    },
    {
      state: 'Delaware',
      phone: '302-235-1975',
      counties: ['New Castle County'],
      cities: ['Hockessin', 'Newark', 'Wilmington', 'Bear', 'New Castle', 'Pike Creek', 'Claymont', 'Elsmere']
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 to-blue-50 dark:from-gray-900 dark:to-gray-800">
      <Helmet>
        <title>Service Areas - Pest Control in PA &amp; DE | Absolute Pest Services</title>
        <meta name="description" content="Absolute Pest Services covers Chester County, Delaware County &amp; Montgomery County PA and New Castle County DE. Local phone numbers &amp; 24/7 emergency pest control service." />
        <link rel="canonical" href="https://absolutepestservices.com/service-areas" />
        <meta property="og:title" content="Service Areas - Pest Control in PA &amp; DE | Absolute Pest Services" />
        <meta property="og:description" content="Professional pest control covering Chester County, Delaware County &amp; Montgomery County PA and New Castle County DE." />
        ...
        <meta name="twitter:description" content="Professional pest control covering PA &amp; DE. Local phone numbers &amp; 24/7 emergency service." />
      </Helmet>
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
            Professional pest control services across Pennsylvania and Delaware. 
            ...
            <CardContent>
              <div className="space-y-3">
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-300">PO Box 8059</p>
        ...
        <div className="text-center">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 mb-8">
            Contact us today for a inspection and customized pest control solution
          </p>
