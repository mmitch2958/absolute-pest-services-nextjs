      ...
      "mainEntity": [
        {
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Getting rid of mice requires a three-step approach: elimination (traps or rodenticide), sanitation (removing food sources and nesting material), and exclusion (sealing entry points). Professional rodent control is most effective because technicians identify all entry points and use placement strategies that DIY methods miss. Call Absolute Pest Services for a inspection."
          }
        },
        {
          "@type": "Question",
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Rodent control costs in Chester County typically range from $150–$600+ depending on the severity of infestation, property size, and whether exclusion work is needed. We offer inspections with transparent pricing."
          }
        },
        {
          "@type": "Question",
  ...
  return (
    <div className="min-h-screen bg-[hsl(0,0%,98%)]">
      <Helmet>
        ...
        <meta name="description" content="Professional mouse &amp; rat exterminator in Chester County, PA. Rodent control, exclusion &amp; prevention. Inspection. Serving West Chester, Kennett Square, Malvern &amp; all Chester County. Call 484-643-2225." />
        ...
        <meta property="og:description" content="Expert rodent control in Chester County, PA. Mouse exterminator, rat control, exclusion services. Inspection. Same-day service available." />
      ...
      <section className="bg-gradient-to-r from-gray-800 to-gray-900 py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="inline-flex items-center gap-2 bg-white/10 text-white text-sm font-semibold px-4 py-2 rounded-full mb-6">
            <Shield className="h-4 w-4" /> Inspection · Same-Day Service Available
          </div>
      ...
      <div className="bg-white border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-wrap justify-center gap-8 text-sm font-medium text-gray-600">
            {["Licensed & Insured in PA", "Inspection", "Exclusion Work Included", "Same-Day Service", "Satisfaction Guaranteed"].map(badge => (
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-4">
            {[
              { q: "How much does rodent control cost in Chester County?", a: "Costs typically range from $150–$600+ for a standard residential treatment. Exclusion work (sealing entry points) may cost additional depending on the scope. We provide inspections with upfront, transparent pricing." },
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div className="text-white space-y-6">
              ...
              <ScheduleInspectionModal>
                ...
                >
                  <Calendar className="mr-2 h-5 w-5" /> Schedule Inspection
                </Button>
              </ScheduleInspectionModal>
            </div>
            <ContactForm />
