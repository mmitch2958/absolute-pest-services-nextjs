...
export default function BatRemoval() {
  ...
  return (
    <div className="min-h-screen bg-[hsl(0,0%,98%)]">
      <Helmet>
        <title>Professional Bat Removal &amp; Exclusion Services | Absolute Pest Services PA & DE</title>
        <meta name="description" content="Safe, humane &amp; legal bat removal in PA &amp; DE. One-way exclusion devices, guano cleanup &amp; permanent sealing. Licensed bat exclusion specialists. Call 610-869-3000 for an inspection." />
        ...
        <meta property="og:description" content="Safe, humane &amp; legal bat removal in PA &amp; DE. One-way exclusion devices, guano cleanup &amp; permanent sealing by licensed specialists." />
        ...
        <meta name="twitter:description" content="Safe, humane &amp; legal bat removal in PA &amp; DE. Licensed specialists with one-way exclusion &amp; permanent sealing." />
      </Helmet>
      {/* Header */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-8">
                ...
                removal services across Pennsylvania and Delaware, including the greater 
