...
export default function TermiteTreatment() {
    ...
    const faqSchema = {
      ...
      "mainEntity": [
        ...
        },
        {
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Yes. We provide official termite inspection reports (WDI reports) commonly required for real estate transactions throughout PA and DE."
          }
        }
      ]
    };
  ...
  return (
    <div className="min-h-screen bg-[hsl(0,0%,98%)]">
      <Helmet>
        <title>Termite Inspection &amp; Treatment Services | Absolute Pest Services PA & DE</title>
        <meta name="description" content="Licensed termite inspection, treatment &amp; prevention in PA &amp; DE. Liquid barriers, baiting systems &amp; ongoing monitoring. Protect your home from costly termite damage. Call 610-869-3000." />
        ...
        <meta property="og:description" content="Licensed termite inspection, treatment &amp; prevention in PA &amp; DE. Liquid barriers, baiting systems &amp; ongoing monitoring to protect your home." />
        ...
        <meta name="twitter:description" content="Licensed termite inspection, treatment &amp; prevention in PA &amp; DE. Protect your home from costly damage." />
      </Helmet>
      {/* Header */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <img 
                ...
                alt="Termite inspection and treatment Chester County PA" 
