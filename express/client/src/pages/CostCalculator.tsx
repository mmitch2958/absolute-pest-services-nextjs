  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Calculate pest control costs instantly. Get free estimates for termite treatment, bed bug removal, wildlife control, and more. Serving PA and DE." />
              ...
              <Card className="bg-green-600 text-white" data-testid="card-cta">
                <CardHeader>
                  ...
                  <CardDescription className="text-green-100">
                    Schedule a inspection for a precise estimate
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  <p className="text-sm">
                    Our cost calculator provides general estimates. For an accurate quote tailored to your specific situation, schedule a inspection with our certified technicians.
                  </p>
