  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 to-blue-50">
      <Helmet>
        ...
        <script type="application/ld+json">{JSON.stringify({"@context":"https://schema.org","@type":"LocalBusiness","name":"Absolute Pest Services – Cochranville, PA Pest Control Services","telephone":"484-643-2225","address":{"@type":"PostalAddress","streetAddress":"PO Box 8059","addressLocality":"West Grove","addressRegion":"PA","postalCode":"19390","addressCountry":"US"},"areaServed":"Cochranville, PA","url":"https://absolutepestservices.com/service-areas/cochranville-pa"})}</script>
      </Helmet>
