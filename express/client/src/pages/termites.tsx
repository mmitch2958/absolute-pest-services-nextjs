...
export default function Termites() {
      ...
      "mainEntity": [
        {
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Termite treatment costs in Chester County typically range from $500–$3,000+ depending on the severity of the infestation, treatment method (liquid barrier, baiting system, fumigation), and the size of your home. We offer inspections to provide an accurate quote."
          }
        },
        {
          "@type": "Question",
        ...
        },
        {
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "We use a combination of liquid termiticide barriers (Termidor®), termite baiting systems (Sentricon®), and wood treatments. The best method depends on your specific situation, which we assess during your inspection."
          }
        },
        {
          "@type": "Question",
  ...
  return (
    <div className="min-h-screen bg-[hsl(0,0%,98%)]">
      <Helmet>
        <title>Termite Treatment Chester County PA | Inspection | Absolute Pest Services</title>
        ...
        <meta property="og:title" content="Termite Treatment Chester County PA | Inspection | Absolute Pest Services" />
      ...
      <section className="bg-gradient-to-r from-[hsl(36,100%,47%)] to-orange-600 py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="inline-flex items-center gap-2 bg-white/20 text-white text-sm font-semibold px-4 py-2 rounded-full mb-6">
            <AlertTriangle className="h-4 w-4" /> Inspection — No Obligation
          </div>
            ...
            {[
              {
                ...
                a: "Termite treatment costs in Chester County typically range from $500–$3,000+ depending on the severity of the infestation, treatment method, and home size. We offer inspections to provide an accurate, no-obligation quote."
              },
              {
                q: "How do I know if I have termites?",
                a: "Common signs include mud tubes along your foundation, hollow-sounding wood, discarded wings near windows/doors, frass (termite droppings), and visibly damaged wood. If you spot any of these, call us immediately for a inspection."
              },
              {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
              Protecting Chester County, PA homes from termites for over 20 years. Schedule your inspection today.
            </p>
          </div>
