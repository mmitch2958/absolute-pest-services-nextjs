...
export default function BedBugs() {
  useEffect(() => {
    ...
    const serviceSchema = {
      ...
      "description": "Professional bed bug extermination and treatment services in Chester County, PA. Heat treatment and chemical treatment options. Inspection available.",
      "provider": {
        "@type": "LocalBusiness",
      ...
      "mainEntity": [
        {
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Bed bug treatment costs in Chester County typically range from $300–$1,500+ per room depending on the treatment method (heat vs. chemical) and severity of infestation. We offer inspections and transparent, upfront pricing."
          }
        },
        {
          "@type": "Question",
  ...
  return (
    <div className="min-h-screen bg-[hsl(0,0%,98%)]">
      <Helmet>
        ...
        <meta property="og:description" content="Professional bed bug extermination in Chester County, PA. Inspection. Heat &amp; chemical treatments. Same-day service available." />
      ...
      <div className="bg-white border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-wrap justify-center gap-8 text-sm font-medium text-gray-600">
            {["Licensed & Insured in PA", "Inspection", "Heat Treatment Available", "Same-Day Service", "100% Satisfaction Guarantee"].map(badge => (
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-4">
            {[
              { q: "How much does bed bug treatment cost in Chester County?", a: "Costs range from $300–$1,500+ per room depending on treatment method and severity. Heat treatment for a whole home typically runs $1,200–$3,000. We provide inspections with transparent, upfront quotes — no surprises." },
