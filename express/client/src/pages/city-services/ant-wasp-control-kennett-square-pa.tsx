...
export default function AntWaspControlKennettSquarePa() {
  ...
  const faqs = [{"q":"What ants, wasps, and stinging insects are common in Kennett Square?","a":"In Kennett Square, we frequently treat carpenter ants, pavement ants, and odorous house ants. Stinging insects like yellow jackets, paper wasps, and bald-faced hornets are common in summer. Boxelder bugs and carpenter bees are also prevalent seasonal pests. Call us for a inspection."},{"q":"When should I call for wasp and hornet nest removal in Kennett Square?","a":"Call as soon as you spot a nest. Wasp and hornet colonies grow rapidly through summer. Early removal is safer and less expensive. We provide same-day or next-day service throughout Kennett Square and surrounding areas."},{"q":"Do carpenter bees damage homes in Kennett Square?","a":"Yes. Carpenter bees drill into wood siding, decks, fascia boards, and railings. Over time this causes structural damage and attracts woodpeckers. We treat existing galleries and apply preventive wood treatments to stop re-infestation."},{"q":"How much does ant and wasp control cost in Kennett Square, PA?","a":"Cost depends on property size, infestation type, and treatment approach. We provide inspections and transparent quotes before any work begins. Call 484-643-2225 to schedule your inspection."}];
      ...
      "mainEntity": [
        {
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "In Kennett Square, we frequently treat carpenter ants, pavement ants, and odorous house ants. Stinging insects like yellow jackets, paper wasps, and bald-faced hornets are common in summer. Boxelder bugs and carpenter bees are also prevalent seasonal pests. Call us for a inspection."
          }
        },
        {
          "@type": "Question",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 to-blue-50">
      <Helmet>
        ...
        <meta name="description" content="Expert ant, wasp, hornet & carpenter bee control in Kennett Square, PA. Licensed & insured. Serving Chester County. Inspection available. Call 484-643-2225." />
        ...
        <meta property="og:description" content="Expert ant, wasp, hornet & carpenter bee control in Kennett Square, PA. Licensed & insured. Serving Chester County. Inspection available. Call 484-643-2225." />
