      ...
      "mainEntity": [
        {
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "In Downingtown, we frequently treat carpenter ants, pavement ants, and odorous house ants. Stinging insects like yellow jackets, paper wasps, and bald-faced hornets are common in summer. Boxelder bugs and carpenter bees are also prevalent seasonal pests. Call us for a inspection."
          }
        },
        {
          "@type": "Question",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 to-blue-50">
      <Helmet>
        ...
        <meta name="description" content="Expert ant, wasp, hornet & carpenter bee control in Downingtown, PA. Licensed & insured. Serving Chester County. Inspection available. Call 484-643-2225." />
        ...
        <meta property="og:description" content="Expert ant, wasp, hornet & carpenter bee control in Downingtown, PA. Licensed & insured. Serving Chester County. Inspection available. Call 484-643-2225." />
