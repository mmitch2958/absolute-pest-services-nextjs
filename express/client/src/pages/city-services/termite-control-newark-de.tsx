  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 to-blue-50">
      <Helmet>
        ...
        <meta name="description" content="Expert termite control in Newark, DE. Licensed & insured. Serving New Castle County. Inspection available. Call 484-643-2225 for fast service." />
        ...
        <meta property="og:description" content="Expert termite control in Newark, DE. Licensed & insured. Serving New Castle County. Inspection available. Call 484-643-2225 for fast service." />
      ...
      <section className="py-16 bg-gradient-to-r from-[hsl(132,48%,35%)] to-[hsl(132,48%,25%)]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-green-100 mb-8">Termite damage is rarely covered by homeowners insurance. Don't wait for signs — proactive termite protection for your Newark, DE property starts with a inspection.</p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="tel:+14846432225"
              className="inline-flex items-center justify-center bg-white text-[hsl(132,48%,35%)] px-8 py-4 text-lg font-semibold hover:bg-gray-100 rounded-md transition-colors"
