...
export default function RequestService() {
  ...
  return (
    <div className="min-h-screen bg-[hsl(0,0%,98%)]">
      <Helmet>
        <title>Request Pest Control Service | Absolute Pest Services PA & DE</title>
        <meta name="description" content="Request professional pest control service in PA &amp; DE. Fast response times, licensed technicians &amp; comprehensive pest management. Get a quote from Absolute Pest Services today." />
        ...
        <meta property="og:description" content="Request professional pest control in PA &amp; DE. Fast response, licensed technicians &amp; comprehensive pest management. Quotes available." />
        ...
        <meta name="twitter:description" content="Request professional pest control in PA &amp; DE. Fast response &amp; quotes available." />
      </Helmet>
      {/* Header */}
