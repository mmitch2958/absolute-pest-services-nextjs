...
export default function Wildlife() {
  useEffect(() => {
    ...
    const serviceSchema = {
      ...
      "description": "Professional wildlife removal and exclusion services in Chester County, PA. Humane raccoon removal, squirrel removal, groundhog control, and more. Inspection available.",
      "provider": {
        "@type": "LocalBusiness",
      ...
      "mainEntity": [
        {
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "We use humane live traps to safely capture raccoons, then relocate them to appropriate habitat away from your property. After removal, we identify and seal all entry points to prevent raccoons from returning. Call us for a inspection."
          }
        },
        {
          "@type": "Question",
        ...
        },
        {
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Wildlife removal costs in Chester County typically range from $200–$1,000+ depending on the species, severity, and exclusion work needed. We provide inspections with upfront, transparent pricing."
          }
        },
        {
          "@type": "Question",
  ...
  return (
    <div className="min-h-screen bg-[hsl(0,0%,98%)]">
      <Helmet>
        ...
        <meta name="description" content="Professional wildlife removal in Chester County, PA. Humane raccoon removal, squirrel removal, groundhog control &amp; more. Licensed PA wildlife control. Inspection. Call 484-643-2225." />
        ...
        <meta property="og:description" content="Humane wildlife removal in Chester County, PA. Raccoon removal, squirrel control, groundhog removal. Licensed & insured. Inspection." />
      ...
      <section className="bg-gradient-to-r from-[hsl(132,48%,35%)] to-[hsl(132,48%,20%)] py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="inline-flex items-center gap-2 bg-white/20 text-white text-sm font-semibold px-4 py-2 rounded-full mb-6">
            <Heart className="h-4 w-4" /> Humane Methods Only · Inspection
          </div>
      ...
      <div className="bg-white border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-wrap justify-center gap-8 text-sm font-medium text-gray-600">
            {["PA Game Commission Licensed", "Humane Methods Only", "Inspection", "24/7 Emergency Service", "Exclusion Work Guaranteed"].map(badge => (
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-4">
            {[
              ...
              { q: "How much does wildlife removal cost in Chester County?", a: "Costs range from $200–$1,000+ depending on species, severity, and exclusion work needed. We provide inspections with transparent, no-obligation quotes." },
