...
export default function LocalSEO({ 
  ...
  description = "Expert pest control services in PA and DE. Humane wildlife control, bed bug treatment, termite control, and bat removal. Licensed and insured.",
  serviceName,
  serviceArea,
  ...
  const pageTitle = `${title} | Absolute Pest Services - PA & DE`;
  const pageDescription = description + " Serving Chester County, Delaware County, Montgomery County PA and New Castle County DE.";
  ...
  useEffect(() => {
    ...
    const localSeoMetas = [
      ...
      { name: 'keywords', content: 'pest control, exterminator, wildlife control, bed bugs, termites, bat removal, Chester County, Delaware County, Montgomery County, New Castle County, West Grove, Hockessin, Newark, Wilmington, Pennsylvania, Delaware' }
    ];
