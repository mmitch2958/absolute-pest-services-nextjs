...
export default function GoogleBusinessIntegration() {
  ...
  const businessInfo = {
    ...
    address: "PO Box 8059, West Grove, PA 19390",
    phone: "484-643-2225",
    rating: reviewData?.rating ?? 5.0,
    reviewCount: reviewData?.reviewCount ?? 29,
...
export function GoogleBusinessSchema() {
  ...
  const schema = {
    ...
    "aggregateRating": {
      ...
      "ratingValue": String(reviewData?.rating ?? 4.8),
      "reviewCount": String(reviewData?.reviewCount ?? 29)
    },
    "review": [
      {
        "@type": "Review",
