    ...
    <>
      ...
      <Card className="bg-white">
        <CardContent className="p-8">
          ...
          <h3 className="text-2xl font-bold text-[hsl(210,13%,28%)] mb-2">Request a Quote</h3>
          <p className="text-gray-500 text-sm mb-6">
            Get an inspection &amp; quote — no obligation. We respond within 2 hours.
          </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <Textarea
                ...
                className="mt-2"
                placeholder="Please describe your pest problem so we can prepare for your inspection..."
                required
              />
            </div>
            ...
            >
              ...
              {submitMutation.isPending ? 'Sending...' : 'Get My Inspection Quote'}
            </Button>
